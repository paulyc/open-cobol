...
\item \textbf{New compiler configuration options}: display-special-fig-consts, free-redefines-position (\fr{211}), line-col-zero-default, perform-without-varying-by, record-delimiter, record-delim-with-fixed-recs, sequential-delimiters
\item \textbf{New runtime configuration options}: col\_just\_lrc (for enabling\slash{}disabling the LEFT\slash{}RIGHT\slash{}CENTER phrases of the report COLUMN clause)
\end{itemize}
