...
\item \textbf{Microsoft Windows}: added -fwinmain option to output WinMain instead of main (\fr{194}).
...
\item \textbf{LENGTH OF phrase}: fixed bugs \bugnoname{89} and \bugnoname{110}.
