...
\item EC-DATA
  ...
  \item EC-DATA-INTEGRITY % NOT IN STANDARD
  \item EC-DATA-PTR-NULL
  \item EC-DATA-NOT-DECIMAL-ENCODING % NOT IN STANDARD
  \item EC-DATA-NOT-FINITE
  % NOT IN GNUCOBOL \item EC-DATA-OVERFLOW
  \end{itemize}
...
\item EC-FLOW
  ...
  \item EC-FLOW-IMP
    % NOT IN GNUCOBOL \item EC-FLOW-RELEASE
    % NOT IN GNUCOBOL \item EC-FLOW-REPORT
  \item EC-FLOW-RETURN
  \item EC-FLOW-SEARCH
  \item EC-FLOW-USE
  \end{itemize}
...
\item EC-FUNCTION
  \begin{itemize}
  \item EC-FUNCTION-NOT-FOUND % NOT IN STANDARD
  \item EC-FUNCTION-PTR-INVALID
  \item EC-FUNCTION-PTR-NULL
  \item EC-FUNCTION-ARG-OMITTED % NOT IN STANDARD
  \end{itemize}
...
\item EC-OO
  \begin{itemize}
  \item EC-OO-ARG-OMITTED % NOT IN STANDARD
  \item EC-OO-CONFORMANCE
  \item EC-OO-EXCEPTION
    % NOT IN GNUCOBOL: \item EC-OO-FINALIZABLE
  \item EC-OO-IMP
  \item EC-OO-METHOD
  \item EC-OO-NULL
  \item EC-OO-RESOURCE
...
\item EC-PROGRAM
  ...
  \item EC-PROGRAM-RECURSIVE-CALL
    % NOT IN STANDARD: EC-PROGRAM-RESOURCES
  \end{itemize}
