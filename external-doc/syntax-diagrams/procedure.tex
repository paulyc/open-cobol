...
\begin{syntax}
  ...
  \begin{1=}
    ...
    \begin{0-1}
      ...
      \pending{WITH \key{NO} \key{REWIND}} \\
      WITH \key{LOCK} \\ % TO-DO: Check!
      \pending{\deleted{REVERSED}}
    \end{0-1}
  \end{1=} \ldots
\end{syntax}
...
The XML GENERATE statement creates an XML document based on the structure and contents of the input data item.
