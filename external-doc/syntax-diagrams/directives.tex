...
\begin{centering}
  \begin{longtable}[!h]{p{0.2\textwidth} p{0.7\textwidth}}
    ...
    HOSTSIGNS & A packed-decimal item's value may be considered NUMERIC if the sign has value X"F". \\
    ...
    NOHOSTSIGNS & A packed-decimal item's value may not be considered NUMERIC if the sign has value X"F". \\
