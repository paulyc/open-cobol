      ...
      ***************************************************************
            ...
            77 STRINGCONTAINS       pic x(128) value "string_contains".
      ...
      ***************************************************************
            ...
            01 watchpoint-lst.
                05 watchpoint-struct occurs 10.
      ...
      *              until tmp-number > 10
      *              
      *              move 'not set' to wp-value(tmp-number)
      *              move 'not set' to last-wp-value(tmp-number)
      *          end-perform
            end-if
